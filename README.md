...
> 매진된 KTX 의 취소표를 대신 기다립니다. (SRT 는 2026-09-01 출발분부터 코레일로 통합돼 KTX-산천으로 같이 찾습니다.) 구간·날짜를 걸어두면 내 폰이나 내 PC가 직접 붙어 빈자리를 찾고, 잡으면 바로 알려줍니다 (자동결제도 됩니다). 철도 계정과 카드는 그 기기 안에 암호화해 둡니다. 화면을 꺼두어도 계속 찾습니다. 승인된 계정과 등록된 기기에서만 동작합니다.

**v2.9.18 · 폰 · PC · KTX 취소표 / 둘 다 같은 프로그램입니다 · 폰 설치 안내**
...
> 상황별 메시지를 빠르게 작성. 설치 없이 브라우저로 바로 사용 · 홈화면 추가 시 앱처럼 동작 · 앱 내 자동 업데이트.
