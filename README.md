...
> 매진된 KTX·SRT 의 취소표를 대신 기다리는 PC 프로그램. 구간·날짜를 걸어두면 이 PC가 직접 찾고, 잡으면 알려줍니다(자동결제도 가능). 철도 계정과 카드는 이 PC 안에만 암호화해 두고 서버로 보내지 않습니다. 화면은 이 컴퓨터에서만 열립니다. 승인된 계정과 등록된 기기에서만 동작.

**v2.0.0 · Windows · KTX/SRT / 18MB · Windows 10/11 · Setup.exe**
