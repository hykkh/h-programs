...
> 매진된 KTX·SRT 의 취소표를 대신 기다립니다. 구간·날짜를 걸어두면 내 폰이나 내 PC가 직접 붙어 빈자리를 찾고, 잡으면 바로 알려줍니다 (자동결제도 됩니다). 철도 계정과 카드는 그 기기 안에만 암호화해 두고 서버로 보내지 않습니다. 화면을 꺼두어도 계속 찾습니다. 승인된 계정과 등록된 기기에서만 동작합니다.

**v2.3.4 · 폰 · PC · KTX/SRT 취소표 / 둘 다 같은 프로그램입니다 · 폰 설치 안내**
